...
## File Metadata
- **Path**: `src/trend-line/pane-renderer.ts`
- **Extension**: `.ts`
- **Lines of Code**: 42
...
This file is located at `src/trend-line/pane-renderer.ts` and contains 42 lines of code.

## TypeScript/JavaScript Code Analysis

### Classes

- **TrendLinePaneRenderer**: Class implementation

### Exports

- **TrendLinePaneRenderer**: Exported symbol
