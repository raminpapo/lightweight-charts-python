...
This file is located at `src/context-menu/context-menu.ts` and contains 154 lines of code.
...
- **camelToTitle**: Function implementation

### Exports

- **camelToTitle**: Exported symbol
- **ContextMenu**: Exported symbol
