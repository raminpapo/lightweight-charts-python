# color-picker.ts Documentation

## File Metadata
- **Path**: `src/context-menu/color-picker.ts`
- **Extension**: `.ts`
- **Lines of Code**: 144
...
This file is located at `src/context-menu/color-picker.ts` and contains 144 lines of code.
