...
This file is located at `src/sample-data.ts` and contains 59 lines of code.

## TypeScript/JavaScript Code Analysis

### Functions

- **generateLineData**: Function implementation
- **generateCandleData**: Function implementation

### Exports

- **generateLineData**: Exported symbol
- **generateCandleData**: Exported symbol
