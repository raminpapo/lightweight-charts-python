...
**File Path:** `src/drawing/drawing.ts`
...
- **Relative Path:** `src/drawing/drawing.ts`
- **File Type:** .ts
- **Size:** 5,604 bytes
- **Total Lines:** 181
...
This file contains 181 lines of typescript.
...
```javascript
import { ... } from './src/drawing/drawing.ts';
```
...
*Documentation generated on 2025-11-18T21:53:49.075988*
