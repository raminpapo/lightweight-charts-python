# drawing-tool.ts Documentation

## File Metadata
- **Path**: `src/drawing/drawing-tool.ts`
- **Extension**: `.ts`
- **Lines of Code**: 122
...
This file is located at `src/drawing/drawing-tool.ts` and contains 122 lines of code.
