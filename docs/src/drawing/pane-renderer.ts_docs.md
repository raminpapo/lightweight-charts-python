...
## File Metadata
- **Path**: `src/drawing/pane-renderer.ts`
- **Extension**: `.ts`
- **Lines of Code**: 65
...
This file is located at `src/drawing/pane-renderer.ts` and contains 65 lines of code.

## TypeScript/JavaScript Code Analysis

### Classes

- **DrawingPaneRenderer**: Class implementation
- **TwoPointDrawingPaneRenderer**: Class implementation
