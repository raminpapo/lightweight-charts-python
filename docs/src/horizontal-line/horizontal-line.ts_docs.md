# horizontal-line.ts Documentation

## File Metadata
- **Path**: `src/horizontal-line/horizontal-line.ts`
- **Extension**: `.ts`
- **Lines of Code**: 99
...
This file is located at `src/horizontal-line/horizontal-line.ts` and contains 99 lines of code.
...
- **HorizontalLine**: Exported symbol
