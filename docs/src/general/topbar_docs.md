...
**File Path:** `src/general/topbar.ts`
...
- **Relative Path:** `src/general/topbar.ts`
- **File Type:** .ts
- **Size:** 6,466 bytes
- **Total Lines:** 178
...
- **`createTopBarContainer()`** (line 27)
- **`createAndReturnSwitcherButton()`** (line 44)

## Detailed Walkthrough

### Code Structure

This file contains 178 lines of typescript.
...
```javascript
import { ... } from './src/general/topbar.ts';
```
...
- File size: 6,466 bytes
- Complexity: 2 functions, 1 classes
...
*Documentation generated on 2025-11-18T21:53:49.134813*
