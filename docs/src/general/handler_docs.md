...
**File Path:** `src/general/handler.ts`
...
- **Relative Path:** `src/general/handler.ts`
- **File Type:** .ts
- **Size:** 12,902 bytes
- **Total Lines:** 369
...
- **`crosshairHandler(chart: Handler, point: any)`** (line 218)
- **`getPoint(series: ISeriesApi<SeriesType>, param: MouseEventParams)`** (line 228)
- **`animateSpinner()`** (line 343)
- **`setChildRange()`** (line 236)
- **`setParentRange()`** (line 239)
- **`setParentCrosshair()`** (line 243)
- **`setChildCrosshair()`** (line 246)

## Detailed Walkthrough

### Code Structure

This file contains 369 lines of typescript.
...
##### crosshairHandler (Line 218)

**Parameters:** `chart: Handler, point: any`

##### getPoint (Line 228)

**Parameters:** `series: ISeriesApi<SeriesType>, param: MouseEventParams`
...
```javascript
import { ... } from './src/general/handler.ts';
```
...
- File size: 12,902 bytes
- Complexity: 7 functions, 1 classes
...
*Documentation generated on 2025-11-18T21:53:49.115511*
