# topbar.ts Documentation

## File Metadata
- **Path**: `src/general/topbar.ts`
- **Extension**: `.ts`
- **Lines of Code**: 178
- **File Size**: 6466 bytes
...
This file is located at `src/general/topbar.ts` and contains 178 lines of code.
...
- **TopBar**: Class implementation

### Exports

- **TopBar**: Exported symbol
