# toolbox.ts Documentation

## File Metadata
- **Path**: `src/general/toolbox.ts`
- **Extension**: `.ts`
- **Lines of Code**: 181
- **File Size**: 7772 bytes
...
This file is located at `src/general/toolbox.ts` and contains 181 lines of code.
...
- **ToolBox**: Class implementation

### Exports

- **ToolBox**: Exported symbol
