...
**File Path:** `src/general/toolbox.ts`
...
- **Relative Path:** `src/general/toolbox.ts`
- **File Type:** .ts
- **Size:** 7,772 bytes
- **Total Lines:** 181
...
```javascript
import { ... } from './src/general/toolbox.ts';
```
...
*Documentation generated on 2025-11-18T21:53:49.108601*
