...
**File Path:** `src/general/legend.ts`
...
- **Relative Path:** `src/general/legend.ts`
- **File Type:** .ts
- **Size:** 9,492 bytes
- **Total Lines:** 233
...
This file contains 233 lines of typescript.
...
```javascript
import { ... } from './src/general/legend.ts';
```
...
*Documentation generated on 2025-11-18T21:53:49.103972*
