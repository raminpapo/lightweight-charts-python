# tables.md Documentation

## File Metadata
- **Path**: `docs/source/reference/tables.md`
- **Extension**: `.md`
- **Lines of Code**: 143
- **File Size**: 3071 bytes
...
This file is located at `docs/source/reference/tables.md` and contains 143 lines of code.
