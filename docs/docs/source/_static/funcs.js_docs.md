# funcs.js Documentation

## File Metadata
- **Path**: `docs/source/_static/funcs.js`
- **Extension**: `.js`
- **Lines of Code**: 478
- **File Size**: 20155 bytes
...
This file is located at `docs/source/_static/funcs.js` and contains 478 lines of code.
...
- **ContextMenu**: Class implementation

### Functions

- **syncCrosshairs**: Function implementation
- **crosshairHandler**: Function implementation
- **stampToDate**: Function implementation
- **dateToStamp**: Function implementation
- **lastBar**: Function implementation
- **calculateTrendLine**: Function implementation
