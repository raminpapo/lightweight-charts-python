# ohlcv.json Documentation

## File Metadata
- **Path**: `docs/source/_static/ohlcv.json`
- **Extension**: `.json`
- **Lines of Code**: 38761
- **File Size**: 804800 bytes
...
This file is located at `docs/source/_static/ohlcv.json` and contains 38761 lines of code.

## Configuration File Analysis

This file contains configuration data in structured format.

### Top-level keys (2 total)
