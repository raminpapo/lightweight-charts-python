# abstract.py Documentation

## File Metadata
- **Path**: `lightweight_charts/abstract.py`
- **Extension**: `.py`
- **Lines of Code**: 962
- **File Size**: 37707 bytes
...
This file is located at `lightweight_charts/abstract.py` and contains 962 lines of code.

## Python Code Analysis

### Classes

- **Window**: Class defined in this file
- **SeriesCommon**: Class defined in this file
- **Line**: Class defined in this file
- **Histogram**: Class defined in this file
- **Candlestick**: Class defined in this file
- **AbstractChart**: Class defined in this file
...
- **on_js_load**(self): Function implementation
- **run_script**(self, script: str, run_last: bool = False): Function implementation
- **run_script_and_get**(self, script: str): Function implementation
- **create_table**(
        self,
        width: NUM,
        height: NUM,
        ...
        draggable: bool = False,
        background_color: str = '#121417',
        border_color: str = 'rgb(70, 70, 70): Function implementation
- **create_subchart**(
        self,
        position: FLOAT = 'left',
        width: float = 0.5,
...
- **style**(
        ...
        hover_background_color: str = '#3c434c',
        click_background_color: str = '#50565E',
        active_background_color: str = 'rgba(0, 122, 255, 0.7): Function implementation
- **__init__**(self, chart: 'AbstractChart', name: str = ''): Function implementation
- **_set_interval**(self, df: pd.DataFrame): Function implementation
- **_format_labels**(data, labels, index, exclude_lowercase): Function implementation
- **rename**(la, mapper): Function implementation
- **_df_datetime_format**(self, df: pd.DataFrame, exclude_lowercase=None): Function implementation
- **_series_datetime_format**(self, series: pd.Series, exclude_lowercase=None): Function implementation
- **_single_datetime_format**(self, arg): Function implementation
- **set**(self, df: Optional[pd.DataFrame] = None, format_cols: bool = True): Function implementation
- **update**(self, series: pd.Series): Function implementation
- **_update_markers**(self): Function implementation
- **marker_list**(self, markers: list): Function implementation
- **marker**(self, time: Optional[datetime] = None, position: MARKER_POSITION = 'below',
               shape: MARKER_SHAPE = 'arrow_up', color: str = '#2196F3', text: str = ''
               ): Function implementation
- **remove_marker**(self, marker_id: str): Function implementation
- **horizontal_line**(self, price: NUM, color: str = 'rgb(122, 146, 202): Function implementation
- **trend_line**(
        self,
        start_time: TIME,
        start_value: NUM,
...
- **box**(
        ...
        round: bool = False,
        color: str = '#1E80F0',
        fill_color: str = 'rgba(255, 255, 255, 0.2): Function implementation
- **ray_line**(
        self,
        start_time: TIME,
        value: NUM,
...
- **clear_markers**(self): Function implementation
- **price_line**(self, label_visible: bool = True, line_visible: bool = True, title: str = ''): Function implementation
- **precision**(self, precision: int): Function implementation
- **hide_data**(self): Function implementation
- **show_data**(self): Function implementation
- **_toggle_data**(self, arg): Function implementation
- **vertical_span**(
        self,
        start_time: Union[TIME, tuple, list],
        end_time: Optional[TIME] = None,
        color: str = 'rgba(252, 219, 3, 0.2): Function implementation
- **__init__**(self, chart, name, color, style, width, price_line, price_label, price_scale_id=None, crosshair_marker=True): Function implementation
- **_set_trend**(self, start_time, start_value, end_time, end_value, ray=False, round=False): Function implementation
- **delete**(self): Function implementation
- **__init__**(self, chart, name, color, price_line, price_label, scale_margin_top, scale_margin_bottom): Function implementation
- **delete**(self): Function implementation
- **scale**(self, scale_margin_top: float = 0.0, scale_margin_bottom: float = 0.0): Function implementation
- **__init__**(self, chart: 'AbstractChart'): Function implementation
- **set**(self, df: Optional[pd.DataFrame] = None, keep_drawings=False): Function implementation
- **update**(self, series: pd.Series, _from_tick=False): Function implementation
- **update_from_tick**(self, series: pd.Series, cumulative_volume: bool = False): Function implementation
- **price_scale**(
        self,
        auto_scale: bool = True,
        mode: PRICE_SCALE_MODE = 'normal',
...
- **candle_style**(
            self, up_color: str = 'rgba(39, 157, 130, 100): Function implementation
- **volume_config**(self, scale_margin_top: float = 0.8, scale_margin_bottom: float = 0.0,
                      up_color='rgba(83,141,131,0.8): Function implementation
- **__init__**(self, window: Window, width: float = 1.0, height: float = 1.0,
                 scale_candles_only: bool = False, toolbox: bool = False,
                 autosize: bool = True, position: FLOAT = 'left'): Function implementation
- **fit**(self): Function implementation
- **create_line**(
            self, name: str = '', color: str = 'rgba(214, 237, 255, 0.6): Function implementation
- **create_histogram**(
            self, name: str = '', color: str = 'rgba(214, 237, 255, 0.6): Function implementation
- **lines**(self): Function implementation
- **set_visible_range**(self, start_time: TIME, end_time: TIME): Function implementation
- **resize**(self, width: Optional[float] = None, height: Optional[float] = None): Function implementation
- **time_scale**(self, right_offset: int = 0, min_bar_spacing: float = 0.5,
                   visible: bool = True, time_visible: bool = True, seconds_visible: bool = False,
                   border_visible: bool = True, border_color: Optional[str] = None): Function implementation
- **layout**(self, background_color: str = '#000000', text_color: Optional[str] = None,
               font_size: Optional[int] = None, font_family: Optional[str] = None): Function implementation
- **grid**(self, vert_enabled: bool = True, horz_enabled: bool = True,
             color: str = 'rgba(29, 30, 38, 5): Function implementation
- **crosshair**(
        self,
        mode: CROSSHAIR_MODE = 'normal',
        vert_visible: bool = True,
        ...
        vert_color: Optional[str] = None,
        vert_style: LINE_STYLE = 'large_dashed',
        vert_label_background_color: str = 'rgb(46, 46, 46): Function implementation
- **watermark**(self, text: str, font_size: int = 44, color: str = 'rgba(180, 180, 200, 0.5): Function implementation
- **legend**(self, visible: bool = False, ohlc: bool = True, percent: bool = True, lines: bool = True,
               color: str = 'rgb(191, 195, 203): Function implementation
- **spinner**(self, visible): Function implementation
- **hotkey**(self, modifier_key: Literal['ctrl', 'alt', 'shift', 'meta', None],
               keys: Union[str, tuple, int], func: Callable): Function implementation
- **create_table**(
        self,
        width: NUM,
        height: NUM,
        ...
        background_color: str = '#121417',
        border_color: str = 'rgb(70, 70, 70): Function implementation
- **screenshot**(self): Function implementation
- **create_subchart**(self, position: FLOAT = 'left', width: float = 0.5, height: float = 0.5,
                        sync: Optional[Union[str, bool]] = None, scale_candles_only: bool = False,
                        sync_crosshairs_only: bool = False,
                        toolbox: bool = False): Function implementation
...
- b64decode
- datetime
- Callable, Union, Literal, List, Optional
- pandas as pd
- Table
- ToolBox
- Box, HorizontalLine, RayLine, TrendLine, TwoPointDrawing, VerticalLine, VerticalSpan
