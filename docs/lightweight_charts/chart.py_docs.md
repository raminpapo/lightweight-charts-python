# chart.py Documentation

## File Metadata
- **Path**: `lightweight_charts/chart.py`
- **Extension**: `.py`
- **Lines of Code**: 237
...
This file is located at `lightweight_charts/chart.py` and contains 237 lines of code.

## Python Code Analysis

### Classes

- **CallbackAPI**: Class defined in this file
- **PyWV**: Class defined in this file
- **WebviewHandler**: Class defined in this file
- **Chart**: Class defined in this file

### Functions

- **__init__**(self, emit_queue): Function implementation
- **callback**(self, message: str): Function implementation
- **__init__**(self, q, emit_q, return_q, loaded_event): Function implementation
- **create_window**(
        self, width, height, x, y, screen=None, on_top=False,
        maximize=False, title=''
    ): Function implementation
- **loop**(self): Function implementation
- **__init__**(self): Function implementation
- **_reset**(self): Function implementation
- **create_window**(
        self, width, height, x, y, screen=None, on_top=False,
        maximize=False, title=''
    ): Function implementation
- **start**(self): Function implementation
- **show**(self, window_num): Function implementation
- **hide**(self, window_num): Function implementation
- **evaluate_js**(self, window_num, script): Function implementation
- **exit**(self): Function implementation
- **__init__**(
        self,
        width: int = 800,
        height: int = 600,
...
- **show**(self, block: bool = False): Function implementation
- **show_async**(self): Function implementation
- **hide**(self): Function implementation
- **exit**(self): Function implementation
