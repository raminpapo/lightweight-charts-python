# table.py Documentation

## File Metadata
- **Path**: `lightweight_charts/table.py`
- **Extension**: `.py`
- **Lines of Code**: 139
...
This file is located at `lightweight_charts/table.py` and contains 139 lines of code.

## Python Code Analysis

### Classes

- **Section**: Class defined in this file
- **Row**: Class defined in this file
- **Table**: Class defined in this file

### Functions

- **__init__**(self, table, section_type): Function implementation
- **__call__**(self, number_of_text_boxes: int, func: Optional[Callable] = None): Function implementation
- **__setitem__**(self, key, value): Function implementation
- **__init__**(self, table, id, items): Function implementation
- **__setitem__**(self, column, value): Function implementation
- **background_color**(self, column, color): Function implementation
- **text_color**(self, column, color): Function implementation
- **_style**(self, style, column, arg): Function implementation
...
- **wrapper**(rId, cId=None): Function implementation
- **async_wrapper**(rId, cId=None): Function implementation
- **new_row**(self, *values, id=None): Function implementation
- **clear**(self): Function implementation
- **get**(self, __key: Union[int, str]): Function implementation
- **__getitem__**(self, item): Function implementation
- **format**(self, column: str, format_str: str): Function implementation
- **resize**(self, width: NUM, height: NUM): Function implementation
- **visible**(self, visible: bool): Function implementation
