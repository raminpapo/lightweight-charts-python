...
## File Metadata
- **Path**: `lightweight_charts/util.py`
- **Extension**: `.py`
- **Lines of Code**: 192
...
This file is located at `lightweight_charts/util.py` and contains 192 lines of code.

## Python Code Analysis

### Classes

- **Pane**: Class defined in this file
- **IDGen**: Class defined in this file
- **Emitter**: Class defined in this file
- **JSEmitter**: Class defined in this file
- **Events**: Class defined in this file
- **BulkRunScript**: Class defined in this file

### Functions

- **__init__**(self, window): Function implementation
- **generate**(self): Function implementation
- **parse_event_message**(window, string): Function implementation
- **js_data**(data: Union[pd.DataFrame, pd.Series]): Function implementation
- **snake_to_camel**(s: str): Function implementation
- **js_json**(d: dict): Function implementation
- **jbool**(b: bool): Function implementation
- **as_enum**(value, string_types): Function implementation
- **marker_shape**(shape: MARKER_SHAPE): Function implementation
- **marker_position**(p: MARKER_POSITION): Function implementation
- **__init__**(self): Function implementation
- **__iadd__**(self, other): Function implementation
- **_emit**(self, *args): Function implementation
- **__init__**(self, chart, name, on_iadd, wrapper=None): Function implementation
- **__iadd__**(self, other): Function implementation
- **final_wrapper**(*arg): Function implementation
- **final_async_wrapper**(*arg): Function implementation
- **__init__**(self, chart): Function implementation
- **__init__**(self, script_func): Function implementation
- **__enter__**(self): Function implementation
- **__exit__**(self, *args): Function implementation
- **add_script**(self, script): Function implementation
