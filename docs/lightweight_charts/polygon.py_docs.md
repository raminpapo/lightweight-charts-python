# polygon.py Documentation

## File Metadata
- **Path**: `lightweight_charts/polygon.py`
- **Extension**: `.py`
- **Lines of Code**: 471
- **File Size**: 18532 bytes
...
This file is located at `lightweight_charts/polygon.py` and contains 471 lines of code.

## Python Code Analysis

### Classes

- **PolygonAPI**: Class defined in this file
- **PolygonChart**: Class defined in this file

### Functions

- **_convert_timeframe**(timeframe): Function implementation
- **_get_sec_type**(ticker): Function implementation
- **_polygon_request**(query_url): Function implementation
- **get_bar_data**(ticker: str, timeframe: str, start_date: str, end_date: str, limit: int = 5_000): Function implementation
- **async_get_bar_data**(ticker: str, timeframe: str, start_date: str, end_date: str, limit: int = 5_000): Function implementation
- **_send**(sec_type: SEC_TYPE, action: str, params: str): Function implementation
- **subscribe**(ticker: str, sec_type: SEC_TYPE, func, args, precision=2): Function implementation
- **unsubscribe**(func): Function implementation
- **_websocket_connect**(sec_type): Function implementation
- **_handle_tick**(ticker, data): Function implementation
- **__init__**(self, chart): Function implementation
- **set**(self, *args): Function implementation
- **async_set**(self, sec_type: Literal['stocks', 'options', 'indices', 'forex', 'crypto'], ticker, timeframe,
                        start_date, end_date, limit, live): Function implementation
- **stock**(
            self, symbol: str, timeframe: str, start_date: str, end_date='now',
            limit: int = 5_000, live: bool = False
...
- **log**(info: bool): Function implementation
- **api_key**(key: str): Function implementation
- **__init__**(
            self, api_key: str, live: bool = False, num_bars: int = 200, end_date: str = 'now', limit: int = 5_000,
            timeframe_options: tuple = ('1min', '5min', '30min', 'D', 'W'): Function implementation
- **_polygon**(self, symbol): Function implementation
- **on_search**(self, chart, searched_string): Function implementation
- **_on_timeframe_selection**(self, chart): Function implementation
- **_on_security_selection**(self, chart): Function implementation
