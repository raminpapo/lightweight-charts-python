...
**File Path:** `lightweight_charts/polygon.py`
...
- **Relative Path:** `lightweight_charts/polygon.py`
- **File Type:** .py
- **Size:** 18,532 bytes
- **Total Lines:** 471
...
- **`PolygonAPI`** (line 224)
- **`PolygonChart`** (line 391)

### Functions (4)

- **`_convert_timeframe(timeframe)`** (line 41)
- **`_get_sec_type(ticker)`** (line 57)
- **`_polygon_request(query_url)`** (line 67)
- **`get_bar_data(ticker: str, timeframe: str, start_date: str, end_date: str, limit: int = 5_000)`** (line 84)
...
This file contains 471 lines of python.
...
##### _convert_timeframe (Line 41)

**Parameters:** `timeframe`

##### _get_sec_type (Line 57)

**Parameters:** `ticker`

##### _polygon_request (Line 67)

**Parameters:** `query_url`

##### get_bar_data (Line 84)

**Parameters:** `ticker: str, timeframe: str, start_date: str, end_date: str, limit: int = 5_000`
...
```python
from lightweight_charts.polygon import *
```
...
- File size: 18,532 bytes
- Complexity: 4 functions, 2 classes
...
*Documentation generated on 2025-11-18T21:53:49.257237*
