# widgets.py Documentation

## File Metadata
- **Path**: `lightweight_charts/widgets.py`
- **Extension**: `.py`
- **Lines of Code**: 188
...
This file is located at `lightweight_charts/widgets.py` and contains 188 lines of code.

## Python Code Analysis

### Classes

- **Bridge**: Class defined in this file
- **WxChart**: Class defined in this file
- **QtChart**: Class defined in this file
- **StaticLWC**: Class defined in this file
- **StreamlitChart**: Class defined in this file
- **JupyterChart**: Class defined in this file

### Functions

- **__init__**(self, chart): Function implementation
- **callback**(self, message): Function implementation
- **emit_callback**(window, string): Function implementation
- **__init__**(self, parent, inner_width: float = 1.0, inner_height: float = 1.0,
                 scale_candles_only: bool = False, toolbox: bool = False): Function implementation
- **get_webview**(self): Function implementation
- **__init__**(self, widget=None, inner_width: float = 1.0, inner_height: float = 1.0,
                 scale_candles_only: bool = False, toolbox: bool = False): Function implementation
- **get_webview**(self): Function implementation
- **__init__**(self, width=None, height=None, inner_width=1, inner_height=1,
                 scale_candles_only: bool = False, toolbox=False, autosize=True): Function implementation
- **run_script**(self, script, run_last=False): Function implementation
- **load**(self): Function implementation
- **_load**(self): Function implementation
- **__init__**(self, width=None, height=None, inner_width=1, inner_height=1, scale_candles_only: bool = False, toolbox: bool = False): Function implementation
- **_load**(self): Function implementation
- **__init__**(self, width: int = 800, height=350, inner_width=1, inner_height=1, scale_candles_only: bool = False, toolbox: bool = False): Function implementation
- **_load**(self): Function implementation
...
- QWebEngineView
- QWebChannel
- QObject, pyqtSlot as Slot, QUrl, QTimer
- QWebEngineView
- QWebChannel
