...
## File Metadata
- **Path**: `lightweight_charts/toolbox.py`
- **Extension**: `.py`
- **Lines of Code**: 46
...
This file is located at `lightweight_charts/toolbox.py` and contains 46 lines of code.
...
- **save_drawings_under**(self, widget: 'Widget'): Function implementation
- **load_drawings**(self, tag: str): Function implementation
- **import_drawings**(self, file_path): Function implementation
- **export_drawings**(self, file_path): Function implementation
- **_save_drawings**(self, drawings): Function implementation
