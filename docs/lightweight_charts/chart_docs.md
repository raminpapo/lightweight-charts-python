...
**File Path:** `lightweight_charts/chart.py`
...
- **Relative Path:** `lightweight_charts/chart.py`
- **File Type:** .py
- **Size:** 7,191 bytes
- **Total Lines:** 237
...
This file contains 237 lines of python.
...
```python
from lightweight_charts.chart import *
```
...
- File size: 7,191 bytes
- Complexity: 0 functions, 4 classes

### Security

- **Recommendation:** Review this file for potential security vulnerabilities
- **Warning:** Potential security concerns found: eval
...
*Documentation generated on 2025-11-18T21:53:49.240329*
