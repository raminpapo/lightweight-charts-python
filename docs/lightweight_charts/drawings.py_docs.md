# drawings.py Documentation

## File Metadata
- **Path**: `lightweight_charts/drawings.py`
- **Extension**: `.py`
- **Lines of Code**: 281
- **File Size**: 8430 bytes
...
This file is located at `lightweight_charts/drawings.py` and contains 281 lines of code.

## Python Code Analysis

### Classes

- **Drawing**: Class defined in this file
- **TwoPointDrawing**: Class defined in this file
- **HorizontalLine**: Class defined in this file
- **VerticalLine**: Class defined in this file
- **RayLine**: Class defined in this file
- **Box**: Class defined in this file
- **TrendLine**: Class defined in this file
- **VerticalSpan**: Class defined in this file

### Functions

- **make_js_point**(chart, time, price): Function implementation
- **__init__**(self, chart, func=None): Function implementation
- **update**(self, *points): Function implementation
- **delete**(self): Function implementation
- **options**(self, color='#1E80F0', style='solid', width=4): Function implementation
- **__init__**(
        self,
        drawing_type,
        chart,
...
- **__init__**(self, chart, price, color, width, style, text, axis_label_visible, func): Function implementation
- **wrapper**(p): Function implementation
- **wrapper_async**(p): Function implementation
- **update**(self, price: float): Function implementation
- **options**(self, color='#1E80F0', style='solid', width=4, text=''): Function implementation
- **__init__**(self, chart, time, color, width, style, text, func=None): Function implementation
- **update**(self, time: TIME): Function implementation
- **options**(self, color='#1E80F0', style='solid', width=4, text=''): Function implementation
- **__init__**(self,
        chart,
        start_time: TIME,
...
- **__init__**(self,
        ...
        width: int,
        style: LINE_STYLE,
        func=None): Function implementation
- **__init__**(self,
        chart,
        start_time: TIME,
        start_value: NUM,
        ...
        style: LINE_STYLE,
        func=None): Function implementation
- **__init__**(self, series: 'SeriesCommon', start_time: Union[TIME, tuple, list], end_time: Optional[TIME] = None,
...
- Union, Optional
- js_json
- NUM, Pane, as_enum, LINE_STYLE, TIME, snake_to_camel
